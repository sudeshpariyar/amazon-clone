...
function Login() {
    ...
    const login =event=>{
        ...
        .then((auth)=>{// logged in, redirected to homepage
            history.push('/');
        })
    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>
                    By signing-in you agree to the Amazon's condition.
                </p><button onClick={register} className="login__registerButton">Create your Amazon Account</button>
            </div>
        </div>
    )
}
